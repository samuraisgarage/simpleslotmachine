    ...
    while True:
        ...
        if amount.isdigit():
            ...
            if MIN_BET <= amount <= MAX_BET:
                ...
                print(f"Balance must be between ${MIN_BET} - ${MAX_BET}.")
        else:
            print("Please enter a number.")
...
def spin(balance):
    ...
    while True:
        ...
        if total_bet > balance:
            print(f"You do not have sufficient funds for this bet... Your current balance is ${balance}.")
        else:
            break
...
def main():
    ...
    print(f"You left the Samurai Casino with ${balance}.")
